...
class PantallaMetricas extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Métricas de Desempeño laboral'),
        actions: [
          IconButton(
...
class _TarjetaMetrica extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cpuCritica = metrica.cpu < 60;
    final ramCritica = metrica.ram < 70;
    final ssdCritica = metrica.ssd < 100; 
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.badge, color: esCritico ? cs.error : cs.primary, size: 18),
            ...
            Text(
              'Horas de trabajo: ${metrica.ssd.toStringAsFixed(0)} hrs/mes',
              style: TextStyle(fontSize: 12, color: cs.onSurfaceVariant),
            ),
            const SizedBox(height: 10),
            _Barra('Rendimiento', metrica.cpu, cpuCritica),
            const SizedBox(height: 4),
            _Barra('Asistencia', metrica.ram, ramCritica),
            const SizedBox(height: 4),
            _Barra('Horas', metrica.ssd, ssdCritica),
          ],
        ),
      ),
    );
