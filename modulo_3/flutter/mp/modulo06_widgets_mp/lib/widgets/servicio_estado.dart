    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Icon(
            _activo ? Icons.badge : Icons.badge_outlined,
            size: 72,
            color: _nivel == 'normal'
                ? Colors.green
                : _nivel == 'warning'
          ...
          Text(
            _activo ? 'Jornada Activa' : 'Jornada Inactiva',
            style: TextStyle(
              fontSize: 15,
          ...
          ElevatedButton.icon(
            ...
            label: Text(
              _activo ? 'Pausar turno' : 'Iniciar turno',
            ),
          ...
          TextButton(
            ...
            child: const Text('Restablecer marcas'),
          ),
          ...
          Opacity(
            ...
            child: Text(
              'Pausas registradas: $_reinicios / $_maxReinicios',
              style: TextStyle(
                fontSize: 13,
          ...
          if (enLimite)
            Padding(
              ...
              child: Text(
                'Límite de pausas de turno alcanzado',
                style: TextStyle(
                  fontSize: 12,
