  ...
  Widget build(BuildContext context) {
    const pasos = [
      _PasoInfo(
        ...
        detalle: 'http.get() + FutureBuilder · Tareas de RRHH',
      ...
      _PasoInfo(
        ...
        detalle: 'TodoDto.fromJson · lista de tareas de RRHH',
      ...
      _PasoInfo(
        ...
        detalle: 'EmpleadoDto · toDomain() · API RRHH',
        icono: Icons.badge,
        color: Colors.orange,
      ),
      _PasoInfo(
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Módulo 12 — API REST Control de RRHH'),
