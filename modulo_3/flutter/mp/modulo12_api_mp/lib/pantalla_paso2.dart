...
class PantallaPaso2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Paso 2 · DTO simple — Tareas de RRHH'),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Chip(
                      label: Text(
                          '${todos.where((t) => t.completed).length} tareas completadas'),
                      backgroundColor: Colors.green[100],
                    ),
                    const SizedBox(width: 8),
                    Chip(
                      label: Text(
                          '${todos.where((t) => !t.completed).length} pendientes de revisión'),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return CheckboxListTile(
                      title: Text('Tarea de RRHH: ${t.title}'),
                      subtitle: Text('ID Expediente: ${t.id}'),
                      value: t.completed,
                      onChanged: null,
